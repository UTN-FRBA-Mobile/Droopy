...
fun LoginScreen(viewModel: LoginViewModel, navigateToSearchInfo: () -> Unit) {
    Box(
        ...
        Login(Modifier.align(Alignment.Center), viewModel, navigateToSearchInfo)
    }
}
...
fun LoginButton(loginEnable: Boolean, onLoginSelected: () -> Unit) {
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            backgroundColor = Color(0xFF4548BB),
            disabledBackgroundColor = Color(0xFF6E7092),
...
fun PasswordField(password: String, onTextFieldChange: (String) -> Unit) {
    TextField(
        ...
        colors = TextFieldDefaults.textFieldColors(
            textColor = Color(0xFF4548BB),
            backgroundColor = Color(0xFFEDEBF1),
...
fun HeaderImage(modifier: Modifier) {
    Image(
        painter = painterResource(id = R.drawable.droopy),
